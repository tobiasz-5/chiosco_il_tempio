...
export default function PrivacyPolicyPage() {
  return (
    <main className="bg-gray-400 max-w-full mx-auto px-6 py-35 text-black text-center space-y-35">
      {/* ========================
           SEZIONE ITALIANA
         ======================== */}
      <section className="space-y-6">
        ...
        <p>
          Maria Grazia Pulzella – Lungarno del Tempio, 50121 Firenze (Italia) – Tel.
          +39 333 369 4137
        </p>
        {/* DESTINATARI */}
        ...
        <p>
          ...
          (art. 28 GDPR) quali: provider di hosting e manutenzione del sito (<strong>Vercel Inc.</strong>),
          servizi di posta elettronica, consulenti IT, fornitori di piattaforme CDN e, previo tuo consenso,
          Google LLC per la visualizzazione di Google Maps.
        </p>
        {/* DATI TRATTATI */}
        ...
        <p>Dati forniti volontariamente tramite form di contatto.</p>
        {/* FINALITÀ TABELLA */}
        ...
        <p>
          Utilizziamo Google Fonts per visualizzare i caratteri tipografici. I file vengono caricati direttamente da Google (USA), 
          ma nessun cookie viene impostato. Per maggiori informazioni consulta la 
          <a href="https://policies.google.com/privacy " target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-700">
        ...
        <p>
          Adottiamo misure tecniche e organizzative adeguate, tra cui connessioni cifrate (TLS 1.3)
        ...
        <p>
          ...
          Venezia 11, 00187 Roma, <a
            ...
            rel="noopener noreferrer"
            className="underline hover:text-blue-700"
          >www.gpdp.it</a>) scrivendo al titolare del trattamento.
        </p>
      ...
      <section className="space-y-6">
        ...
        <p>
          ...
          interacting with <em>www.chioscoiltempio.com</em>. It explains how we collect, use and protect personal data and how you can exercise your rights.
        </p>
        {/* CONTROLLER */}
        <h2 className="text-xl font-semibold">Controller</h2>
        <p>
          Maria Grazia Pulzella – Lungarno del Tempio, 50121 Florence (Italy) – Tel.
          +39 333 369 4137
        </p>
        {/* RECIPIENTS */}
        ...
        <p>
          ...
          including: hosting/maintenance services (<strong>Vercel Inc.</strong>), email services, IT consultants, CDN providers and,
        ...
        <p>Data voluntarily provided via contact forms.</p>
        {/* TABLE PURPOSES */}
        ...
        <h2 className="text-xl font-semibold">Google Fonts</h2>
        <p>
          We use Google Fonts to display typographic characters. Files are loaded from Google servers (USA) but no cookies are set. For more information, see the{" "}
          <a
            href="https://policies.google.com/privacy "
            target="_blank"
            rel="noopener noreferrer"
        ...
        {/* COOKIES THIRD PARTY - ENGLISH */}
        <h2 className="text-xl font-semibold">Cookies & third-party services</h2>
        <p>
          We load the <strong>Google Maps</strong> iframe only after your explicit consent. Google LLC is certified under the{" "}
          <strong>EU-US Data Privacy Framework</strong> and, alternatively, uses Standard Contractual Clauses approved by the EU Commission.
          More info:{" "}
          <a
            href="https://policies.google.com/privacy "
            target="_blank"
        ...
        <p>
          Data may be transferred to the United States only where adequate safeguards under Articles 45–46 GDPR are in place (EU-US DPF or SCC).
          You can request a copy of such safeguards by contacting the controller.
        </p>
        {/* MANDATORY NATURE - ENGLISH */}
        <h2 className="text-xl font-semibold">Mandatory or voluntary nature of providing data</h2>
        <p>
          Providing data for technical purposes is necessary for browsing the site; refusing optional data (e.g., in contact forms)
          may prevent responses. Declining third-party cookies does not hinder basic navigation.
        </p>
        {/* AUTOMATED DECISIONS - ENGLISH */}
        <h2 className="text-xl font-semibold">Automated decision-making</h2>
        <p>No automated decisions or profiling are carried out.</p>
        {/* SECURITY MEASURES - ENGLISH */}
        <h2 className="text-xl font-semibold">Security measures</h2>
        <p>
          We implement appropriate technical and organisational measures such as TLS 1.3 encrypted connections and regular software updates.
        </p>
        {/* USER RIGHTS - ENGLISH */}
        <h2 className="text-xl font-semibold">Your rights</h2>
        <p>
          Under Articles 15–22 GDPR you may request access, rectification, erasure, restriction, portability or object to processing.
          You also have the right to lodge a complaint with the Italian Supervisory Authority (Garante per la Protezione dei Dati Personali, Piazza Venezia 11, 00187 Rome,{" "}
          <a
            href="https://www.gpdp.it "
            target="_blank"
            rel="noopener noreferrer"
